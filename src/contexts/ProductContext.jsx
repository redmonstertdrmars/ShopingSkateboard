...
import { calcSubPrice, calcTotalPrice } from '../Helpers/calsPrice'
...
const ProductContextProvider = ({ children }) => {
    ...
    const addComent = async (newProduct) => {
        try {
            let res = await axios.post(`${API}/products`, newProduct)
            return res
        } catch (err) {
    ...
    const editCommentProduct = async (id, product) => {
